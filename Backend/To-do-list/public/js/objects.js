document.addEventListener("DOMContentLoaded", function() {
    ...
    //     .then(data => {
    //         const itemContainer = document.querySelector(".rightSection")
    //         const newToDoItem = document.createElement('div');
    //         newToDoItem.textContent = data.text;
    //         itemContainer.appendChild(newToDoItem);
    //         newToDoItem.classList.add.newItem;
    //         textArea.value = '';
    //     })
    ...
    //   }
      ...
      textField.addEventListener("keydown", function(e){
        ...
        let originalDiv = document.querySelector(".rightItems");
        let newLiItem = document.createElement("li");
        let liBox = document.querySelector(".items")
        let textDiv = newLiItem.querySelector("p");
    ...
    //     if (event.key === 'Enter'){
    //         const var1 = document.querySelector(".textArea");
    //         const var2 = var1.value.trim();
    //         if (var2 !== ""){
    //             appendToOutput(var2);
    //             var1.value = "";
    //         }
    ...
    //     const outputBox = document.querySelector(".rightSection");

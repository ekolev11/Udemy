    ...
    function addTodo(){
        ...
        <div class="checkText">
            ...
            <p class="text text${noteID}">${inputValue}</p>
                ...
                <button class="delete delete${noteID}" ><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 384 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
